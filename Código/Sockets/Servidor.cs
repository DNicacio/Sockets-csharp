...
namespace Sockets
{
    public partial class Servidor : Form
    {
        ...
        {
            this.NovoArquivoRecebido += new FileRecievedEventHandler(Servidor_NovoArquivoRecebido);
        }
        private void Servidor_NovoArquivoRecebido(object fonte, string nomeArquivo)
        {
            this.BeginInvoke(
             new Action(
             delegate ()
